...
* link:./ts/010a-system-design.adoc[TS-10a: *System Design*]
* link:./ts/010b-modeling.adoc[TS-10b: *Modeling*]
* link:./ts/011a-application-architecture.adoc[TS-11a: *Application Architecture*]
* link:./ts/011b-code-design.adoc[TS-11b: *Code Design*]
...
* link:./ts/017a-sh.adoc[TS-17a: *Unix Shells*]
* link:./ts/017b-cli.adoc[TS-17b: *Command Line Interfaces (CLIs)*]
