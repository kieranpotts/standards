...
cover coding conventions for a wide variety of computer languages. However,
these standards are restricted to technical concerns only. They do not cover,
for example, project management and software delivery methodologies, nor testing
and release strategies or other processes in the software development life cycle.
