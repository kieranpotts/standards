...
For these reasons, NFRs can be much harder to change than FRs in the later stages of a project. Therefore, it is important that all NFRs are identified and accounted for in the system requirements specification as early as possible in the project life cycle.
