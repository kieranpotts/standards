...
Related technical standards include *link:../010/README.adoc[TS-10: System Design]*, which describes general software architectural design best practices and standards; and *link:../013/README.adoc[TS-13: Code Design]*, which covers concerns such as code formatting and low-level design patterns.
