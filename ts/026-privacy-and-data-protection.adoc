= TS-26: Privacy and Data Protection
...
3. Embed privacy into the design of IT systems and business processes. Privacy should be integral to an system, not an add-on.
