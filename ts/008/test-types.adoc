...
Compliance testing verifies that the system adheres to industry standards, regulatory requirements, organizational procedures, and contractual obligations.

Best practices: 

* Identify all relevant standards, regulations, and guidelines early in the project lifecycle.

* Create compliance checklists mapped to specific requirements.

* Maintain traceability between requirements and test cases.

* Engage compliance experts or auditors when testing against complex regulations.

* Document compliance evidence thoroughly for audit purposes.

== Security testing

Security testing evaluates the system's ability to protect data and functionality against unauthorized access, malicious attacks, and unintentional damage.

Security testing tends to focus on things like authentication, authorization, data encryption, and vulnerability scanning.

Best practices:

* Conduct security testing throughout the development lifecycle. Don't leave it to just before release.

* Use automated vulnerability scanners complemented by manual penetration testing.

* Test all access control mechanisms, including authentication and authorization.

* Verify that sensitive data is encrypted in transit and at rest.

* Engage security specialists for critical systems. 

* Follow established frameworks such as the OWASP Testing Guide.

// TODO: Includes *penetration testing*.

== Usability testing

Usability testing assesses the ease of use, intuitiveness, and user-friendliness of the application. User interface testing specifically evaluates whether users can operate the application effectively without extensive training or assistance.

Best practices:

* Recruit participants who represent actual target users, not developers or testers. 

* Observe users completing realistic tasks without providing guidance or assistance. 

* Measure task completion rates, time on task, and error rates quantitatively.

* Gather qualitative feedback through interviews or surveys.

* Test early prototypes to identify issues before full implementation. 
