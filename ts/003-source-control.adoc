...
#===============================================================================
# <type> can be:
#   - feature      a new, changed, or deprecated feature
#   - performance  an optimization of the system's operation at runtime
#   - fix          a bug fix
#   - dev          an increment toward implementing a feature, fix, or 
#                  performance optimization
#   - refactor     a change to the structure of production, test, or other code
#   - maintenance  changes to documentation and other housekeeping tasks
