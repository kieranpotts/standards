...
This technical standard extends *link:../019/README.adoc[TS-19: Unix Shells]* with guidelines for using the https://www.gnu.org/software/bash/[Bash shell] specifically. Everything in TS-19 applies here, too; TS-19a extends TS-19.
