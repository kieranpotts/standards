...
// .Threat assessment
// |===
// |Ref |Component |Threat description |Threat type |Countermeasures |Likelihood |Impact |Rating

// |#1
// |Application logs
// |Sensitive data leaking into logs
// |Information disclosure (PII)
// |Least-privileged access to logs; review logging code; review logs; automatic static analysis of logs; log rotation
// |Low
// |Low
// |Low
// |===
