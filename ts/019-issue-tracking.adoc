...
Related issues SHOULD be linked together. Where multiple issues need to be completed to deliver value to end users, the issues SHOULD be grouped under a single parent "epic" issue.
