...
.Further reading
****
* https://www.gnu.org/prep/standards/html_node/Errors.html[Formatting error messages] — The relevant section from the GNU coding standards.
****
