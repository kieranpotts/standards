...
Epic integrations are typically performed via a pull request, which provides a structured forum for review and approval of the consolidated change. See *link:./pr-config.adoc[PR config]*.
