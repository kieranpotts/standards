...
The branch-to-environment mapping described above supports a range of deployment strategies (big bang, blue/green, canary, rolling, feature flags). The choice of strategy is covered in *link:../010/README.adoc[TS-10: Releasing]*.
