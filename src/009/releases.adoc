...
The choice of release *cadence* (big bang, release trains, or continuous deployment) and *rollout strategy* (rolling, canary, blue/green, feature flags) is covered in detail in *link:../004/README.adoc[TS-4: Releasing]*. This section of TS-3 focuses on the version-control mechanics that support those choices.
