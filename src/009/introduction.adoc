...
See also *link:../002/README.adoc[TS-2: Issue Tracking]*, which establishes a framework for issue tracking that is compatible with the version control conventions outlined in TS-3. *link:../047/README.adoc[TS-47: GitHub Actions]* covers best practices for working with GitHub's integrated CI/CD tools.
