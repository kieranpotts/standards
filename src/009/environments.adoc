...
The branch-to-environment mapping described above supports a range of deployment strategies (big bang, blue/green, canary, rolling, feature flags). The choice of strategy is covered in *link:../004/README.adoc[TS-4: Releasing]*.
