...
A *style* commit applies presentation-only changes – updates to markup, style, or formatting. These are changes that affect the rendered appearance of the document without changing the underlying content.
