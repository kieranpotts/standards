...
**Assessment.** TS-37 is currently a stub: `src/037/README.adoc` contains
only a TODO introductory placeholder and "See also" links to TS-18 and TS-63,
and `src/037/AGENTS.md` is an empty `<!-- TODO -->`. The standard therefore
...
- [ ] https://www.trysmudford.com/blog/hyper-responsive-web-components/
      ...
      section in `src/037/README.adoc`.
...
- [ ] https://daverupert.com/2024/10/super-web-components-sunshine/ ("The
      ...
      components. Recommend a new section in `src/037/README.adoc`.
...
- [ ] https://daverupert.com/2024/10/super-web-components-sunshine/ ("The
      ...
      it out of the box. Recommend a new section in `src/037/README.adoc`.
...
- [ ] https://daverupert.com/2024/10/super-web-components-sunshine/ ("The
      ...
      to resolve it. Recommend a new section in `src/037/README.adoc`.
...
- [ ] https://adactio.com/journal/20618 ("HTML web components", opening
      ...
      Recommend a new section in `src/037/README.adoc`.
...
- [ ] https://adactio.com/journal/20618 ("HTML web components", "I have a
      ...
      then enhancing. Recommend a new section in `src/037/README.adoc`.
...
- [ ] https://adactio.com/journal/20618 (Jim Nielsen response, "On The Web,
      ...
      via web components). Recommend a new section in `src/037/README.adoc`.
...
- [ ] TS-37 is a stub (`src/037/README.adoc` holds only a TODO intro and
      "See also" links; `src/037/AGENTS.md` is `<!-- TODO -->`). With no body
