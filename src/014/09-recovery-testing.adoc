...
Recovery testing is closely related to resilience, and overlaps with chaos testing (covered in link:../008/README.adoc[TS-8: Functional Testing]). Where chaos testing proactively introduces failures to discover unknown weaknesses, recovery testing validates that known recovery procedures work correctly and meet their defined objectives.
