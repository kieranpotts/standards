...
Recovery testing is closely related to resilience, and overlaps with chaos testing (covered in link:../013/README.adoc[TS-13: Functional Testing]). Where chaos testing proactively introduces failures to discover unknown weaknesses, recovery testing validates that known recovery procedures work correctly and meet their defined objectives.
