...
* Include a specific version of the action, which you have audited. Best
  ...
  ensures that the action's code is locked down and cannot be changed without
  you explicitly updating the version referenced from your workflow
  configuration. This will help to protect you from unexpected supply-chain
