...
resources (the in-repository `src/039/__TODO__/` backlog of source
material intended to become this standard):

- `src/039/__TODO__/forms-and-inputs.adoc`
- `src/039/__TODO__/References.txt`
- `src/039/__TODO__/html/_index.md`
- `src/039/__TODO__/html/100-encoding.md`
- `src/039/__TODO__/html/_150-elements.md`
- `src/039/__TODO__/html/_200-head.md`
- `src/039/__TODO__/html/_250-metadata.md`
- `src/039/__TODO__/html/_300-hyperlinks.md`
- `src/039/__TODO__/html/_350-forms.md`
- `src/039/__TODO__/html/400-figures.md`
- `src/039/__TODO__/html/_420-images.md`
- `src/039/__TODO__/html/_440-av.md`
- `src/039/__TODO__/html/_700-accessibility.md`
- `src/039/__TODO__/html/_accessibility testing checklist.txt`
- `src/039/__TODO__/html/_todo/*.md`
- `src/039/__TODO__/html/_todo/HOUSE STYLE.md`
- `src/039/__TODO__/html/_todo/*.URL`
- `src/039/__TODO__/svg/_todo/*.URL`
...
- [ ] `src/039/__TODO__/html/100-encoding.md:3` — documents MUST be UTF-8;
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:150` — `<!DOCTYPE html>`
      MUST be column 1, line 1, to prevent quirks mode. Recommend new
      section "Doctype".

### Document structure & source order

- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:12` — source order
...
- [ ] `src/039/__TODO__/html/_todo/document-structure.md:1` — document
      structure, outline, and source order topic with reference list.
      Recommend new section "Document structure".
- [ ] `src/039/__TODO__/html/_todo/sections-and-document-outline.md:4`
...
- [ ] `src/039/__TODO__/html/_150-elements.md:5` — the allowed-element
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:404` — alternative
...
- [ ] `src/039/__TODO__/html/_200-head.md:65` — `<title>` REQUIRED in all
      ...
      new section "Title".
- [ ] `src/039/__TODO__/html/_200-head.md:109` — meta-tag guidance:
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:245` — description meta
      ...
      `_200-head.md`).
- [ ] `src/039/__TODO__/html/_200-head.md:186` — `<link>` relationships:
...
- [ ] `src/039/__TODO__/html/_todo/text-content.md:5` — inline text
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:614` — allowed inline
...
- [ ] `src/039/__TODO__/html/_todo/text-content.md:30` — heading
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:471` — heading levels
...
- [ ] `src/039/__TODO__/html/_todo/text-content.md:44` — list rules:
      ...
      section "Lists".
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:493` — list guidance:
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:596` — `<hr>` represents
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:702` — `<pre>` for
...
- [ ] `src/039/__TODO__/html/_todo/tables.md:3` — tables only for tabular
...
- [ ] `src/039/__TODO__/html/_420-images.md:183` — raster image file
...
- [ ] `src/039/__TODO__/html/_420-images.md:222` — image optimisation
      ...
      optimisation".
- [ ] `src/039/__TODO__/html/_420-images.md:240` — serving raster images
...
- [ ] `src/039/__TODO__/html/_420-images.md:256` — responsive images:
...
- [ ] `src/039/__TODO__/html/_420-images.md:417` — alternative
...
- [ ] `src/039/__TODO__/html/_420-images.md:475` — image maps (`<area>`/
      `<map>`) still standard and supported but largely obsolete given
      SVG/canvas. Recommend new section "Image maps".
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:749` — `<img>`:
      ...
      sources).
- [ ] `src/039/__TODO__/html/_todo/images-and-multimedia.md:3` —
      `width`/`height` MUST be on all images/audio/video/embedded media.
      Recommend new section "Images" / "Audio & video".

### SVG / vector graphics

- [ ] `src/039/__TODO__/html/_420-images.md:23` — SVG is the only web
...
- [ ] `src/039/__TODO__/html/_420-images.md:37` — linking vs inlining
...
- [ ] `src/039/__TODO__/html/_420-images.md:71` — mandatory/recommended
      ...
      attributes".
- [ ] `src/039/__TODO__/html/_420-images.md:157` — SVG filters
      (blur/colour manipulation; supported except IE≤9 / Android <4.4;
      examples TODO). Recommend new section "SVG filters".
- [ ] `src/039/__TODO__/html/_420-images.md:163` — SVG animation
      ...
      animations".
- [ ] `src/039/__TODO__/html/_420-images.md:179` — keyboard navigation
      considerations for inlined SVGs (cross-reference accessibility).
      Recommend new section "SVG keyboard navigation".
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:777` — prefer embedding
...
- [ ] `src/039/__TODO__/svg/_todo/Tips for Creating and Exporting Better SVGs for the Web.URL:2`
...
- [ ] `src/039/__TODO__/html/_440-av.md:1` — Audio & Video topic (stub).
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:789` — `<audio>`/`<video>`
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:801` — embedded media:
      ...
      media & iframes".
- [ ] `src/039/__TODO__/html/_todo/images-and-multimedia.md:35` — iOS
...
- [ ] `src/039/__TODO__/html/_todo/forms.md:36` — specific-format inputs
      should offer options rather than free text where possible.
      Recommend new section "Forms".
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:813` — `<form>` MUST
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:833` — native
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:860` — input-control
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:892` — per-control
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:1079` — `<fieldset>`
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:1093` — only `<button>`
...
- [ ] `src/039/__TODO__/html/_300-hyperlinks.md:1` — Hyperlinks topic
      (stub).
- [ ] `src/039/__TODO__/html/_todo/links.md:7` — URLs MUST conform to RFC
      ...
      "Hyperlinks".
- [ ] `src/039/__TODO__/html/_todo/links.md:51` — all initially-rendered
...
- [ ] `src/039/__TODO__/html/_todo/links.md:71` — avoid `mailto:` (use a
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:627` — `<a>` as
...
- [ ] `src/039/__TODO__/html/_250-metadata.md:1` — metadata overview;
      Schema.org + Microformats chosen; don't mix schemas; syntax vs
      vocabulary distinction. Recommend new section "Metadata".
- [ ] `src/039/__TODO__/html/_250-metadata.md:17` — Schema.org via RDFa
...
- [ ] `src/039/__TODO__/html/_250-metadata.md:128` — Microformats
...
- [ ] `src/039/__TODO__/html/_todo/scripting-and-data.md:3` — adding
...
- [ ] `src/039/__TODO__/html/_todo/scripting-and-data.md:18` — progressive
...
- [ ] `src/039/__TODO__/html/_todo/scripting-and-data.md:140` — `data-*`
      ...
      attributes".
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:360` — all pages work
...
- [ ] `src/039/__TODO__/html/_todo/templates.md:3` — `<template>`
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:1122` — until
...
- [ ] `src/039/__TODO__/html/_todo/built-in-widgets.md:3` — `<meter>`/
      `<progress>` elements; context-menu / `<menu>` topic (TODO).
      Recommend new section "Built-in widgets".
- [ ] `src/039/__TODO__/html/_todo/content-security-policy.md:1` —
...
- [ ] `src/039/__TODO__/html/_todo/semantics.md:12` — semantic markup
      ...
      "Semantics".
- [ ] `src/039/__TODO__/html/_todo/semantics.md:25` — deprecated
...
- [ ] `src/039/__TODO__/html/_todo/semantics.md:45` — avoid presentational
...
- [ ] `src/039/__TODO__/html/_todo/i18n.md:1` — internationalisation &
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:176` — declare `lang`
...
- [ ] `src/039/__TODO__/html/_todo/style.md:1` — minimal markup without
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:2` — overall house
      ...
      style".
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:29` — indentation (4
      spaces, no tabs, block-level on new lines). Recommend new section
      "Coding style" → "Indentation".
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:46` — tag names
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:58` — attributes
      lowercase, alphabetical order, double quotes, valueless booleans.
      Recommend new section "Coding style" → "Attributes".
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:82` — `id` for hash
...
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:120` — escaping
      ...
      "Escaping".
- [ ] `src/039/__TODO__/html/_todo/HOUSE STYLE.md:1134` — use the
...
- [ ] `src/039/__TODO__/html/_700-accessibility.md:1` — Accessibility
      topic (stub).
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:5` — keyboard
...
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:34` — modal popup
...
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:43` — `accesskey`
...
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:90` — visibility &
...
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:186` — WAI-ARIA
...
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:273` — avoid
      ...
      → "Redundant ARIA".
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:342` — full ARIA role
...
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:563` — tooltips: no
...
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:600` — alerts &
...
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:629` — custom
...
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:697` — forms
...
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:727` — `role="search"`
      for complex search components. Recommend new section "Accessibility"
      → "Search".
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:749` — custom input
...
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:943` — directory
      trees & treegrids (`tree`/`treeitem`/`treegrid`). Recommend new
      section "Accessibility" → "Trees".
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:951` — custom
...
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:977` — landmark
      ...
      roles".
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:1011` — ARIA best
...
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:2412` — keyboard
...
- [ ] `src/039/__TODO__/html/_todo/accessibility.md:2542` — testing tips
...
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:3` —
...
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:22`
...
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:37`
...
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:49`
...
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:68`
...
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:92`
      ...
      accessible".
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:101`
...
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:109`
      — seizures: no flashing >3×/second. Recommend new section
      "Accessibility checklist" → "Seizures".
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:115`
      ...
      "Navigable".
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:129`
...
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:140`
      — readable: page `lang`; per-content `lang` for different
      languages. Recommend new section "Accessibility checklist" →
      "Readable".
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:147`
...
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:156`
...
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:168`
...
- [ ] `src/039/README.adoc:25` states the *philosophy* of a "working
...
- [ ] `src/039/README.adoc:19` foreshadows the redundancy concern
      ...
      `src/039/__TODO__/html/_250-metadata.md:126` and
      `src/039/__TODO__/html/_todo/accessibility.md:273`). Recommend new
      section "Redundancy between HTML, ARIA, and metadata".
- [ ] `src/039/README.adoc:17` foreshadows the unreliable-support concern
...
- [ ] `src/039/__TODO__/html/_todo/semantic-web.md:1` — "Semantic Web"
...
- [ ] `src/039/__TODO__/html/_accessibility testing checklist.txt:7`
      — CI/Axe tooling configuration on the `dev` branch is process/
      tooling, not an HTML authoring rule. Flagged for the user to
      confirm or overrule.
- [ ] `src/039/__TODO__/html/_todo/misc.md:1` and
      `src/039/__TODO__/html/_todo/document-structure.md:5` and
      `src/039/__TODO__/html/_todo/semantics.md:5` etc. — these files
...
- [ ] `src/039/__TODO__/html/_todo/Tutorials Overview • WAI Web Accessibility Tutorials.URL:2`
...
- [ ] `src/039/__TODO__/html/_todo/Web accessibility – Style.ONS.URL:2`
...
- [ ] `src/039/__TODO__/html/_todo/Inclusive Components by Heydon Pickering.pdf`,
...
- [ ] `src/039/__TODO__/html/_todo/document-outline-sections.png` —
