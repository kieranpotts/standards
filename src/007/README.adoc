...
While code design decisions are important, you should not dwell on them. Instead, focus on logical separation, data structures, communication patterns, and other architecturally-significant decisions. These concerns are the subject of link:../005/README.adoc[TS-5: Application Architecture] and link:../002/README.adoc[TS-2: Software Design Qualities].
