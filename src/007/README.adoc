...
While code design decisions are important, you should not dwell on them. Instead, focus on logical separation, data structures, communication patterns, and other architecturally-significant decisions. These concerns are the subject of link:../012/README.adoc[TS-12: Application Architecture] and link:../010/README.adoc[TS-10: Software Design Qualities].
