...
by a linter running in continuous integration, taking subjectivity out of code
review. The conventions below are the defaults where a project does not specify
otherwise.
