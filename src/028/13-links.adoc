...
https://asciidoctor.org/docs/user-manual/#complex-urls[Asciidoctor:
Troubleshooting URLs] for help solving this.
...
For guidance on writing effective link text, see *link:../026/README.adoc[TS-26:
...
It is RECOMMENDED to distinguish internal from external links by making only
internal links bold.
