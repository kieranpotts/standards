...
1. Be proactive about privacy, not reactive. Anticipate and prevent privacy breaches before they happen.

2. Build maximum privacy in to default settings. Users may explicitly opt-in to reduce privacy settings, but maximum privacy safeguards must be the default. Thus, if users do nothing, they are protected.
