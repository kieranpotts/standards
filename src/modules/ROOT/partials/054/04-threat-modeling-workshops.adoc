...
RECOMMENDED to schedule threat modeling workshops at the breakpoint between each
iterative development or release cycle. Betters still, workshops should be
...
frameworks such as STRIDE and PASTA.

See also *link:image$054/examples/threat-modeling-workshop.md[this concrete example]*
of a threat modeling workshop report, which is based on the same template.
