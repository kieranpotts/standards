...
* Tarandach, Coles (2020).
  _Threat Modeling: A Practical Guide for Development Teams_. O'Reilly.
  https://amzn.eu/d/0RReqZB
* Shostack (2014). _Threat Modeling: Designing for Security_. Wiley.
  https://amzn.eu/d/5IePlBn
* Schoenfield (2021).
  _Securing Systems: Applied Security Architecture and Threat Models_. CRC
  Press. https://amzn.eu/d/a6Jpt5I
