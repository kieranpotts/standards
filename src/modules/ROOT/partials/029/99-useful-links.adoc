...
* https://ajv.js.org/[ajv] — JavaScript/TypeScript. The most widely used validator in the Node.js ecosystem; supports Draft 2020-12 and JTD (see <<json-type-definition-jtd,JSON Type Definition (JTD)>>).

* https://python-jsonschema.readthedocs.io/[jsonschema] — Python. The reference implementation used by most Python projects that validate against JSON Schema.

* https://github.com/santhosh-tekuri/jsonschema[santhosh-tekuri/jsonschema] — Go. A dependency-free validator supporting Draft 2020-12.
