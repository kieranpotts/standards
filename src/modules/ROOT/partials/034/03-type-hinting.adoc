...
****
See also PSR-5: https://github.com/php-fig/fig-standards/blob/master/proposed/phpdoc.md

phpstan is a popular static analysis tool that extends type safety of PHP code via phpdocs: https://phpstan.org/writing-php-code/phpdoc-types
****
