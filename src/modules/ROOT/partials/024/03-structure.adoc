...
- *Task-based guides.* Step-by-step instructions for a single, named task ("Invite a teammate", "Cancel a subscription"). See <<task-based-writing,Task-based writing>> for how these are written.
...
- *Troubleshooting and FAQs.* Answers to specific failure modes and recurring questions. See <<troubleshooting-and-faqs,Troubleshooting and FAQs>>.
