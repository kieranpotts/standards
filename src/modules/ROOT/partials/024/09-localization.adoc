...
Where full localization of an entire manual is not feasible, prioritize the content the widest audience needs most: getting-started material and the most common troubleshooting entries (see <<feedback-and-metrics,Feedback and metrics>> for identifying these) over exhaustive reference material, which a motivated reader can more readily work through even in a non-native language.
