...
Package names MUST be written in lowercase (see <<naming-styles,Naming styles>>), using only letters and digits. Hyphens are not valid in Java identifiers, so they cannot appear in package names.
