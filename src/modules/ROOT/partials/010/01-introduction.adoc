...
See also xref:009.adoc[TS-9] for the branching, integration, and release-trunk/release-branch mechanics that underpin these release strategies, and xref:011.adoc[TS-11] for version numbering.
