...
* *Trunk-based development*: Feature flags allow incomplete features to be merged to the main branch without exposing them to end users, supporting continuous integration. See xref:009.adoc[TS-9].
