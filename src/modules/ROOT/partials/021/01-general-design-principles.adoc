...
Where there is doubt about whether an input deviation is safe to tolerate, prefer rejecting the request with a `400 Bad Request` over silently guessing the client's intent.
