...
* *Exemplary.* Include examples and tutorials for the most common use cases. Many readers look at examples first. But do not attempt to example everything. There are tradeoffs. Too many examples reduce skim-ability, and reduce their own individual usefulness.
...
* *Comprehensive.* Together, all the document, in all its forms, should answer all the important questions that all stakeholders are likely to have about a system. Of course, satisfying every obscure question is unattainable. The objective is to cover the most important views and questions comprehensively.
