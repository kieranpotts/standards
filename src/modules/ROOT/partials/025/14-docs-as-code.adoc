...
- Documentation authored in a lightweight markup language — Markdown, AsciiDoc, or reStructuredText — rather than a binary format or a proprietary CMS. See xref:027.adoc[TS-27] and xref:028.adoc[TS-28].
