...
As per xref:007.adoc[TS-7], err on the side of clarity over brevity in the naming of things. Do not truncate or abbreviate the names of things where doing so would decrease understandability of the code.
