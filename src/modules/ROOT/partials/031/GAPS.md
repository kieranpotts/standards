...
- [ ] `__TODO__/031/shell/unix/input.md:3-5` — the `read` built-in for
...
- [ ] `__TODO__/031/shell/unix/input.md:7-9` — the basic `read my_var` form
...
- [ ] `__TODO__/031/shell/unix/input.md:11-19` — prompting the user with an
...
- [ ] `__TODO__/031/shell/unix/input.md:21-29` — the alternative pattern of
...
- [ ] `__TODO__/031/shell/unix/input.md:31-37` — UX guidance on prompt
...
- [ ] `__TODO__/031/shell/unix/input.md:39-43` — hidden/silent input for
