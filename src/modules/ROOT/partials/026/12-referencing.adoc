...
* *Biblical citation.* Cite as `<Book> <chapter>:<verse>` — "John 3:16," or a range as "Romans 8:28-30." Abbreviate the book name only where the document already establishes the abbreviation on first use, following the same first-use rule as any other abbreviation — see <<abbreviations-and-acronyms,Abbreviations and acronyms>>.
