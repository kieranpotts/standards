...
2. *Data retention.* Decide what happens to the service's data — archived to cold storage for compliance or auditing purposes, migrated into a replacement service's data model, or deleted outright — and confirm the decision satisfies any regulatory or contractual retention obligations before deletion becomes irreversible.
