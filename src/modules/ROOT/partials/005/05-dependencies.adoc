...
* xref:garden::reliability.adoc[*Reliability*]. What is its track record for uptime and correctness, and what support or SLA backs it when something goes wrong?
