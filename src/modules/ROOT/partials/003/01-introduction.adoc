...
A design doc records the technical _how_ and _why_ of a system — the design. For the _what_ — the system's externally-observable behavior and acceptance criteria — see xref:001.adoc[TS-1]. For the qualities a good design exhibits, see xref:002.adoc[TS-2].
