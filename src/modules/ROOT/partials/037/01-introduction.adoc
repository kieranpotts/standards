...
This standard does not cover CSS layout and typography techniques (fluid type, container queries, intrinsic layouts) — see xref:018.adoc[TS-18] for those. For the design of URLs, see xref:063.adoc[TS-63].
