...
NOTE: Much of the guidance in this section is drawn from Uncle Bob's bible on https://www.goodreads.com/book/show/3735293-clean-code[clean code].
...
This tension is not a flaw in the guidance – it is the normal condition of design work. What it demands is empirical judgment: assess the result by reading it, and by asking whether the next person will find it comprehensible. See xref:002.adoc[TS-2] for this same principle applied to habitability more broadly.
