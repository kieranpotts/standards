...
The so-called "self-documenting code" approach, popularized by https://www.goodreads.com/book/show/3735293-clean-code[Uncle Bob's "Clean Code" book], encourages developers to express intent through well-named abstractions rather than comments.
