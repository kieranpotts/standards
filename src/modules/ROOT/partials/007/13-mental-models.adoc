...
.TL;DR
****
* Build a small model of a system's core primitives and the principles that generate its behavior, rather than memorizing rules and edge cases.
