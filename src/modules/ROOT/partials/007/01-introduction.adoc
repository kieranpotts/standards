...
While code design decisions are important, you should not dwell on them. Instead, focus on logical separation, data structures, communication patterns, and other architecturally-significant decisions. These concerns are the subject of xref:005.adoc[TS-5] and xref:002.adoc[TS-2].
