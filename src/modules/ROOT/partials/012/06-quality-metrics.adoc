...
* *Test coverage* — the percentage of code exercised by automated tests. Coverage is a useful indicator of untested areas, but it is a poor measure of test quality. High coverage with weak assertions provides false confidence. See xref:013.adoc[TS-13] for detailed guidance on coverage.
