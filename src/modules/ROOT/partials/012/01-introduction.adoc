...
This standard focuses on the _process_ of quality assurance: how quality is organized, what gates exist, how quality is measured, and how a culture of quality is sustained. For the specifics of testing, see xref:013.adoc[TS-13] and xref:014.adoc[TS-14]. For release strategies including canary testing and staged rollouts, which are also important quality control practices, see xref:010.adoc[TS-10].
