...
* *xref:garden::correctness.adoc[Correctness]* — does the code do what it is supposed to do? Does it handle edge cases and error conditions?
...
* *xref:garden::completeness.adoc[Completeness]* — does the change address the full scope of the requirement, including documentation updates, configuration changes, and migration scripts?
