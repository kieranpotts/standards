...
For production release strategies — including canary releases, A/B testing, and staged rollouts — see xref:010.adoc[TS-10]. For chaos engineering and resilience testing in production, see the test strategies section of xref:013.adoc[TS-13].
