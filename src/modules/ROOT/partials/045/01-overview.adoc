...
It does not cover routine data _ingestion_ or ETL pipelines whose purpose is to feed downstream analytics, nor does it cover backup and restore as a disaster-recovery activity — though the techniques overlap. For release mechanics around the switch-over, see xref:010.adoc[TS-10].
