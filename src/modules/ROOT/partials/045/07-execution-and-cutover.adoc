...
For release mechanics — feature flags, canary rollout, and rollback orchestration — see xref:010.adoc[TS-10]. For the runbook as a documentation artifact, see xref:025.adoc[TS-25].
