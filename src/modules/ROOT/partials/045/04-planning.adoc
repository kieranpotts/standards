...
It SHOULD be written down, reviewed, and stored alongside the code — see xref:003.adoc[*TS-3*].
...
* The feature flags or configuration that gate each step. See xref:010.adoc[*TS-10*].
