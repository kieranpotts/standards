...
See also xref:008.adoc[TS-8], which establishes a framework for issue tracking that is compatible with the version control conventions outlined in TS-9. xref:060.adoc[TS-60] covers best practices for working with GitHub's integrated CI/CD tools.
