...
+
The RECOMMENDED approach is to open a pull request from the epic branch to `dev` and use the PR system's squash-merge option. See <<integrating-epic-branches-into-dev,Integrating epic branches into dev>> and <<pr-config,PR config>> for details.
+
