...
See also https://www.gitworktree.org/[gitworktree.org], a community-maintained reference covering `git worktree` commands, workflows, and IDE integrations in more depth than is in scope for this technical standard.
