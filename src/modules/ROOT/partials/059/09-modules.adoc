...
* `README.md` — A human-readable description of the module, its inputs, and its outputs. The https://github.com/terraform-modules/terraform-module-template[terraform-module-template] repository is a good starting point.
* `examples/` — One or more runnable example configurations that demonstrate how to use the module. Examples are also used by https://developer.hashicorp.com/terraform/cli/commands/test[`terraform test`] and by https://developer.hashicorp.com/terraform/registry/modules/publish[the Terraform Registry] to validate the module.
