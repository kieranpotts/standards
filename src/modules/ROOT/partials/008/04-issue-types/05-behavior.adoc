...
Features originate from functional requirements (FRs) defined as part of the system requirements specification (SRS). Features SHOULD be specified using a consistent convention for acceptance criteria, such as user stories or use cases, which describe the features from the perspective of the users to whom they provide value. See xref:001.adoc[TS-1].
