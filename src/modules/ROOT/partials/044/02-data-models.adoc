...
Do not use a search engine as the sole store for data the application cannot afford to lose or reconstruct — see <<selecting-a-database,Selecting a database>>.
