...
For the broader distributed-systems treatment of replication, caching, and staleness — which applies regardless of whether the underlying store is relational or NoSQL — see xref:046.adoc[TS-46].
