...
For the equivalent relational schema-design guidance — normalization, naming conventions, and data typing for a joinable, normalized model — see xref:043.adoc[TS-43].
