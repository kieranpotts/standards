...
YAML resolves most scalars to a type implicitly, using the rules of its core schema (see <<implicit-typing,Booleans, nulls, and implicit typing>>). A tag (`!` or `!!`) MAY be used to state a type explicitly, overriding implicit resolution:
