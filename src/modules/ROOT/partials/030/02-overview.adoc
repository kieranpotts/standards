...
* A strict, versioned contract validated at both ends — prefer JSON with xref:029.adoc[TS-29], or protocol buffers.
...
GitHub Actions workflows and custom actions — used throughout this organization's repositories for CI/CD — are defined entirely in YAML. See xref:060.adoc[TS-60] for workflow-specific guidance that builds on this standard.
