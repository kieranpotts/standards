...
Either way, the harness still has to be engineered. Adopting one settles what you start from, not how it is configured, constrained, and evolved thereafter. That is the subject of the next section, on <<harness-engineering,harness engineering>>.
