...
Broadly, there are three ways of working with AI tools on software. All three are modes of <<ai-augmented-software-development,AI-augmented software development>>, in that a human remains in the loop throughout. What separates them is how correctness is established.

* In xref:garden::vibe-coding.adoc[*vibe coding*], correctness is established by observation. The code runs, the output looks right, and that is the whole of the verification.
