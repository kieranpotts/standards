...
- *Reliability*, including the technology's own failure modes and how they interact with the resilience patterns described in <<resilience-and-blast-radius,Resilience and blast radius>>.
