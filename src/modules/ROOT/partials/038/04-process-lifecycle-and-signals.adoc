...
The forced-exit timeout MUST be shorter than the orchestrator's own grace period (Kubernetes'
...
<<error-handling-and-logging,Error handling and logging>>) rather than to *recover* and keep running. An application MUST NOT catch these
