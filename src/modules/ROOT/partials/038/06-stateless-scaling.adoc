...
handled the client's previous request. See xref:006.adoc[TS-6] for the broader
statelessness and idempotency principles this rests on, and xref:049.adoc[TS-49] for
