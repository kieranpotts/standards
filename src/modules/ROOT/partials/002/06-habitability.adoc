...
Of all internal qualities, *habitability* is the most fundamental. In broad terms, this is synonymous with the concept of *xref:garden::developer-experience.adoc[developer experience]*.
