...
Markdown is a lightweight markup language with a plain-text formatting syntax. Its design goal is to be readable as-is,
without the formatting tags or instructions of a richer markup language, while still allowing the text to be converted
to structured formats such as HTML.

Markdown is suited to short, relatively simple documents. For longer or more structured technical documentation,
AsciiDoc is RECOMMENDED; see xref:028.adoc[*TS-28: AsciiDoc*].
