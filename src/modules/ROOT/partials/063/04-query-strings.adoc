...
The path identifies the resource; the query string parameterizes the request. Values that change _which_ resource is identified belong in the path. Values that change _how_ the resource is represented or selected belong in the query string.
