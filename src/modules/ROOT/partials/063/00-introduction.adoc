...
For general user interface design principles, see xref:015.adoc[TS-15]. For web GUI implementation, see xref:018.adoc[TS-18]. For search engine optimization, see xref:019.adoc[TS-19]. For HTTP API resource modeling and versioning, see xref:021.adoc[TS-21].
