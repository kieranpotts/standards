...
JavaScript packages are versioned using a numbering system extended from the https://semver.org/[Semantic Versioning] convention. A semantic version number consists of three parts:
