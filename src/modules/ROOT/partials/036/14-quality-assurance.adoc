...
Our preference is Mocha plus Chai and Sinon, which together cover everything from small packages to large applications. https://mochajs.org/[Mocha] is a test framework that structures test suites and test cases (`describe`, `it`); https://chaijs.com/[Chai] is an assertion library; https://sinonjs.org/[Sinon] provides spies and stubs. Alternatives include Jest, Ava, and Jasmine. Other specialized tools include https://github.com/nock/nock[Nock] for HTTP mocking, https://www.npmjs.com/package/jsdom[jsdom] (with mocha-jsdom) for emulating a browser environment, and https://www.selenium.dev/[Selenium] or Cypress for web automation.
...
https://eslint.org/[ESLint] is the industry-standard tool for static analysis of JavaScript code. Low-level style concerns SHOULD be enforced through ESLint rather than by hand.
