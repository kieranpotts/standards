...
Short interface text — labels, button text, status messages, tooltips — is a different register from the longer-form documentation prose covered by xref:026.adoc[TS-26]. It follows its own, tighter conventions:
