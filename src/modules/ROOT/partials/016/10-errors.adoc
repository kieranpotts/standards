...
title, an optional longer description, and how to fix it – linking to the stable error-code page (see <<Supporting bug
reporting>>) for more detail rather than dumping everything into the terminal.
