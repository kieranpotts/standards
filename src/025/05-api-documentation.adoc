...
This is the literate programming principle  applied to interfaces. Documentation generated from the source cannot drift from the source, because it _is_ the source, rendered.
