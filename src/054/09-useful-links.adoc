...
* https://adam.shostack.org/games.html[Evelation of Privilege games]: Adam Shostack authored the Elevation of Privilege game and maintains
  a running list of gamification helpers on his personal blog site.
