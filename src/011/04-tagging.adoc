...
see *link:../009/README.adoc[TS-9: Version Control]*.
...
repository (see *link:../009/README.adoc[TS-9: Version Control]*).
...
reachable from the pushed commits in a single operation, use `git push
--follow-tags`.
======
