...
statement or the body of a method, constructor, or _named_ class. Thus, `else`,
`catch`, `finally`, and `while` keywords go immediately after the closing brace
of the preceding block, because these represent a continuation of the preceding
block statement.
...
and between the double slash and the code where this comment notation is used to
comment-out code.
