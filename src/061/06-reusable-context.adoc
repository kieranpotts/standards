...
Some agent harnesses will also look for global skills in locations in the user's home directory. This is really useful for sharing common workflow skills across multiple projects. But support is patchy. As of 2026, only a few harnesses like Pi support the automatic discover of global skills.
...
When writing a skill intended for broad deployment across multiple agent harnesses, check how each target harness resolves and activates skills. If you harness persists in context all auto-discovered skills, then you will need to be extra vigilant in designing your skills for token efficiency.
