...
- `src/015/__TODO__/API Design.md` (local file)
- `src/015/__TODO__/guidelines.md` (link list — Atlassian, BBC GEL, CFPB, IBM,
  Microsoft Windows, Polaris, and others that failed to fetch)
- `src/015/__TODO__/usability.md` (link list — Nielsen Norman Group,
  usability.gov, Google Design, Usability Post)
- `src/015/__TODO__/laws-of-ux` → https://lawsofux.com/
...
- [ ] `src/015/__TODO__/API Design.md` (lines 1–13) frames API design as
...
- [ ] `src/015/__TODO__/API Design.md` (lines 21–44, "Simplicity") is not
...
- [ ] `src/015/__TODO__/API Design.md` (lines 46–67) is not addressed anywhere
...
- [ ] `src/015/__TODO__/ui/` and `src/015/__TODO__/ui2/` are empty directories;
      nothing to extract.