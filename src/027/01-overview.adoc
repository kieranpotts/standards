...
Markdown is suited to short, relatively simple documents. For longer or more structured technical documentation, AsciiDoc is RECOMMENDED; see link:../028/README.adoc[TS-28: AsciiDoc].
