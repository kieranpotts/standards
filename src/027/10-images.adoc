...
All images MUST have alternative text. The alternative text SHOULD concisely describe the content of the image; see link:../026/README.adoc[TS-26: Technical Writing Style Guide] for guidance.
