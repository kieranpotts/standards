...
A migration plan that does not state the classification of its data is incomplete. See *link:../053/README.adoc[TS-53: Privacy and Data Protection]*.
...
The migration's credentials SHOULD be distinct from any long-lived application or operator credential, so that they can be revoked without affecting other work. See *link:../052/README.adoc[TS-52: Security and Secrets Management]*.
