...
For the general principles of observability, see *link:../057/README.adoc[TS-57: Logging, Monitoring, Observability]*. This section addresses what is specific to migrations.
