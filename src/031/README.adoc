...
As per *link:../007/README.adoc[TS-7: Code Design]*, err on the side of clarity over brevity in the naming of things. Do not truncate or abbreviate the names of things where doing so would decrease understandability of the code.
