...
Cohesiveness – used here as a synonym for what Fred Brooks called _conceptual integrity_ – is the degree to which a software system's design forms a unified, consistent whole.
...
The difficulty lies in achieving and maintaining cohesiveness over time. The dominant theme throughout Brooks's _The Mythical Man-Month_ is the question of how best to manage complexity in large-scale software systems. Maintaining conceptual integrity, Brooks argues, is the best way of containing that complexity.
