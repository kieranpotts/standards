...
Just like maintaining a home or garden, a habitable codebase requires regular housekeeping and tending. As systems are modified and extended, entropy inevitably sets in, and investment in refactoring and maintence is required to preserve the habitability of the space.
