...
> Additional gaps that belong in TS-6 (when written) are recorded in: `src/005/GAPS.md` (microservices prerequisites, service sizing, monolith-to-microservices migration execution, SOLID at service level, continuous technology re-evaluation).