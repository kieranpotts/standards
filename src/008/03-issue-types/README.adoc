...
An issue may or may not be small enough to be implemented in a single *atomic commit*. If not, a *temporary branch* MAY be used to implement the changes over multiple commits. See *link:../003/README.adoc[TS-3: Version Control]*.
