...
* *Requirements clarity* — ambiguous or incomplete requirements are the single largest source of defects. Investing time in clear, testable requirements (see *link:../006/README.adoc[TS-6: Requirements Specification]*) directly reduces defect rates.
...
* *Test-driven development* — writing tests before implementation forces developers to think through requirements, edge cases, and interface design before writing production code. See *link:../008/README.adoc[TS-8: Functional Testing]* for detailed guidance.
