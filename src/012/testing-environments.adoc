...
For production release strategies — including canary releases, A/B testing, and staged rollouts — see link:../004/README.adoc[TS-4: Releasing]. For chaos engineering and resilience testing in production, see the test strategies section of link:../008/README.adoc[TS-8: Functional Testing].
