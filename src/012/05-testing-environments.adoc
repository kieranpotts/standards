...
For production release strategies — including canary releases, A/B testing, and staged rollouts — see link:../010/README.adoc[TS-10: Releasing]. For chaos engineering and resilience testing in production, see the test strategies section of link:../013/README.adoc[TS-13: Functional Testing].
