...
* *Test coverage* — the percentage of code exercised by automated tests. Coverage is a useful indicator of untested areas, but it is a poor measure of test quality. High coverage with weak assertions provides false confidence. See link:../008/README.adoc[TS-8: Functional Testing] for detailed guidance on coverage.
