...
https://pubs.opengroup.org/onlinepubs/9699919799/basedefs/V1_chap12.html[defines
a notation] for describing the APIs — the subcommands, arguments and flags — of
command line utilities. Most CLI environments, including Node.js, adopt this
notation for documentation purposes.
...
signature, only the most useful and most widely used options. It is RECOMMENDED
that extended user documentation be published online, in which lesser-used
commands and options are fully documented, too.
...
in the help text. If it is useful, include the program's expected output in the
examples, too.
...
this MUST be versioned documentation, corresponding to the installed version of
the program.
