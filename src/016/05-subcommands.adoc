...
pattern. The first seems to be the more common pattern — eg .`docker container
create` — but either is fine as long as you are consistent.
...
ins`, or even just `mycmd i`. Now you're stuck. You can't add any more commands
beginning with `i`. There's nothing in principle wrong with aliases — saving on
typing is good — but they should be explicit and remain stable.
