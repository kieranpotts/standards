...
Error messages SHOULD be written to stderr when a command returns a non-zero exit code. See the section on link:./10-errors.adoc[errors] for more guidance on how error messages can be used to support debugging of failure modes.
